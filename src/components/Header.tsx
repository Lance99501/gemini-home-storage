        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between py-3.5 gap-3">
          ...
          <div className="flex items-center gap-2 self-end md:self-center">
            ...
            <div className="relative" ref={expiryMenuRef}>
              ...
              {/* Expiration Alerts Popover Dropdown */}
              {showExpiryMenu && (
                <div
                  id="header-expiry-alerts-panel"
                  className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-2xl shadow-xl border border-slate-200 p-4 z-40 text-xs animate-fadeIn"
                >
                  ...
                  {expirySummary.totalAlertCount > 0 && (
                    <button
                      ...
                      className="w-full mt-2 py-2 bg-slate-900 text-white rounded-xl text-center text-xs font-semibold hover:bg-slate-800 transition-colors flex items-center justify-center gap-1 cursor-pointer"
                    >
                      在物品清單中檢視與整理所有提醒項目
